...
public class DAOClient {
	...
	private static final String SELECT_CLIENT_BY_EMAIL_AND_PASSWORD = "SELECT * FROM client WHERE email=? AND password=?";
	...
	public Client selectClientByEmailAndPassword(String email, String password) {
		...
		try {
			PreparedStatement statement = connection.prepareStatement(SELECT_CLIENT_BY_EMAIL_AND_PASSWORD);
